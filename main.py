...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-confs',
        default="cvpr,iccv,eccv,nips,icml,iclr,mm,aaai,ijcai",
        type=str,
    ...
    parser.add_argument(
        '-keys',
        default="relation, relationship,correlate,correlation",
        type=str,
        help='What keywords you want to query?')
    parser.add_argument(
        '-cc', default=0, type=int, help='Count the citations?')
